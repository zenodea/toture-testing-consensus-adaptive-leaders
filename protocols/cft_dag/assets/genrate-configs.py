...
parser.add_argument('--wave_length', type=int, default=2, help='Wave length (default: 2)')
...
parser.add_argument('--transaction_size', type=int, default=8, help='Transaction size (default: 8)')
parser.add_argument('--output_dir', type=str, default="protocols/cft_dag/assets/", help='configuration file output directory')
