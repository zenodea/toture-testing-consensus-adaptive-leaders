...
plt.grid(True)
plt.tight_layout()
plt.savefig(OUTPUT_FILE_ROOT + "/etcd_throughput.pdf")
print("Generated throughput plot in " + OUTPUT_FILE_ROOT + "/etcd_throughput.pdf")
...
plt.grid(True)
plt.tight_layout()
plt.savefig(OUTPUT_FILE_ROOT + "/etcd_latency.pdf")
print("Generated latency plot in " + OUTPUT_FILE_ROOT + "/etcd_latency.pdf")