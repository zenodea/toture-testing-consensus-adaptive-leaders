...
- nodes: list of replica nodes in the network, with 0 indexing; nodes[0] is the first replica with a consensus client running in it (id = 2)
- links: list of links between nodes, with 0 indexing; links[0][1] is the link between node id 2 and 3
- oracle: LeaderOracle retrieves the set of leaders sorted in the descending order of their resource usage, and contains the original node ids (not indexes); i.e. the minimum returned value is 2