...
for protocol in cft_dag dedis_paxos quepaxa sadl_racs efficient rabia; do
  /bin/bash  consenbench/scripts/dry_setup.sh  "${protocol}" noop ens5
  size=18
  for load in 10000 100000 200000 300000 400000 500000 600000 700000 800000 900000 10000000; do
